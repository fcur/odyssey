...
public sealed class JourneyController: ControllerBase
{
    ...
    public async Task<IActionResult> GetJourney([FromRoute] Guid id)
    {
    ...
    public async Task<IActionResult> CreateJourney([FromBody] CreateJourneyRequestDto requestDto)
    {
    ...
    public async Task<IActionResult> UpdateJourney([FromRoute] Guid id, [FromBody] UpdateJourneyRequestDto requestDto)
    {
