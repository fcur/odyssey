...
public sealed record JourneyStoryError : DomainError
{
    ...
    public static JourneyStoryError UnsupportedEvent(string eventName, string eventType) => new JourneyStoryError("UnsupportedEvent", $"Can't handle not supported event '{eventName}' with type '{eventType}'");
