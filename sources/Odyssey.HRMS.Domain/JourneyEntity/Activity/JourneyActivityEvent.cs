...
public sealed record JourneyActivityEvent(JourneyActivityEventName Name, JourneyActivityEventType Type, JourneyActivityId? NextActivityId)
{
    ...
    public static readonly JourneyActivityEvent ActivityFinished = new JourneyActivityEvent(JourneyActivityEventName.ActivityFinished, JourneyActivityEventType.Flow, null);
}
