...
//         var timeOffRounding = new TimeRounding(TimeSpan.FromSeconds(1));
//
...
//     {
//         return new TimeOffSettings(paidTimeOffDuration, unpaidTimeOffDuration, familyTimeOffDuration, timeRounding);
//     }
//
//     public static TimeOffSettings Create(
...
//             new TimeRounding(timeOffRounding));
//     }
// }
